...
var scaleIntervals = {
    ...
    "melodic minor ascending": [2, 3, 5, 7, 9, 11, 12],
    "pentatonic": [2, 4, 7, 9, 12],
    "octatonic": [1, 3],
    "enigmatic": [1, 4, 6, 8, 10, 11, 12],
    "double harmonic": [1, 4, 5, 7, 8, 11, 12],
    "neapolitan minor": [1, 3, 5, 7, 8, 11, 12],
    "neapolitan major": [1, 3, 5, 7, 9, 11, 12],
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Populate the select element with the keys from scaleIntervals
    Object.keys(scaleIntervals).forEach(scaleName => {
        const option = document.createElement('option');
        option.value = scaleName;
        option.textContent = capitalizeFirstLetter(scaleName);
